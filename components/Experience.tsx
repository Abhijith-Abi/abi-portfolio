        ...
        <section id="experience">
            ...
            <div className=" container mx-auto 2xl ">
                ...
                <p className="text-gray-300 pt-5">
                    ...
                    In the realm of Next.js, I've honed my skills to develop
                    cutting-edge web applications with seamless server-side
                    rendering and optimized performance. This includes creating
                    efficient and intuitive user interfaces that enhance the
                    overall user journey. Moreover, my experience as a React.js
                    and Next.js developer has given me a solid foundation in
                    navigating the latest trends and technologies in the
                    ever-evolving field of web development. I am passionate
                    about leveraging these skills to build innovative and
                    cross-platform solutions that excel on both the web and
                    mobile platforms.
                </p>
